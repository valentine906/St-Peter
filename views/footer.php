    ...
    <div class="footerTop">
        ...
        <div class="row">
            ...
            <div class="large-4 medium-6 small-12 columns footer-widget">
                ...
                <p>
                    Thank you for your interest in St Peters Special Secondary School, Oba website. Know about our vision , mission and beliefs. We believe you will not regret sending your wards to attend our school
                </p>
            </div><!-- Widget 1 ends /-->
                ...
                <div class="textwidget">
                    <ul class="address">
                        ...
                        <li>
                            ...
                            <h4>Email:</h4>
                            <p>peterssecschool@donschools.com</p>
                        </li>
                    </ul>
                    <hr>
    ...
    <div class="footerbottom">
        ...
        <div class="row">
            ...
            <div class="medium-6 small-12 columns">
                <div class="copyrightinfo">&copy;2019 St Peters Special Secondary School, Oba | All Rights Reserved<br><a href="https://www.solecnetlinks.com">Designed by SolecNetlinks </a></div>
            </div><!-- left side /-->
